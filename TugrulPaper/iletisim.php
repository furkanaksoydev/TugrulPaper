...
<html lang"tr">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/iletisimm.css">
    </head>
        ...
        <section class="iletisim-kismi">
                <div class="iletisim">
                       <div class="konteynir">
                                ...
                                <div class="iletisim-konteynir">
                                    ...
                                    <div class="iletisim-overlay">
                                        <div class="iletisim-link">
                                            <a href="mailto:tugrulkaan12345@gmail.com">G-Mail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col3">
                                <div class="iletisim-konteynir">
                                    <img src="resimler/insta.jpg" class="fotoğraf-over">
                                    <div class="iletisim-overlay">
                                        <div class="iletisim-link">
                                            <a href="https://www.instagram.com/kaan___t/">Instagram</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col3">
                                <div class="iletisim-konteynir">
                                    ...
                                    <div class="iletisim-overlay">
                                        <div class="iletisim-link">
                                            <a href="https://wa.me/905537229610">WhatsApp</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
